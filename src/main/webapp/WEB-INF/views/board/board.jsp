...
<body>
	...
	<main class="container py-5" style="min-height: 730px;">
		...
		<nav class="nav d-flex justify-content-center">
			<a class="p-2 link-secondary text-warning border-bottom border-warning" href="/board/list.do">전체</a>
			<a class="p-2 link-secondary" href="/board/list.do?category=공지사항">공지사항</a>
			<a class="p-2 link-secondary" href="/board/list.do?category=잡담">잡담</a>
			<a class="p-2 link-secondary" href="/board/list.do?category=정보">정보</a>
						...
						<a href="detail.do?boardIdx=${item.boardIdx}">
							<div class="row py-2 my-2 border-bottom">
								...
								<div class="col-11">
									<div class="container">
										<div style="margin-bottom: 5px;">
											<span class="category">${item.boardCategory }</span>
											<span class="postTitle">${item.boardTitle }</span>
