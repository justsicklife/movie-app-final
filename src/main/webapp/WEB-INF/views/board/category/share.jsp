...
<body>
	...
	<main class="container py-5" style="min-height: 730px;">
		...
		<nav class="nav d-flex justify-content-center">
			...
			<a class="p-2 link-secondary text-warning border-bottom border-warning" href="/board/list.do?category=공유">공유</a>
		</nav>
		<!-- 게시물 목록 -->
									...
									<span class="category">${ntc.boardCategory }</span> <span
										class="postTitle">${ntc.boardTitle }</span>
											<c:if test="${item.boardCommentCnt != 0 }">
												<span class="postTitle">${item.boardCommentCnt }</span>
											</c:if>
								</div>
							</div>
						</div>
